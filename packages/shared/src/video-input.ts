...
/**
 * The video JSON contract (CLAUDE.md prime directive #1). Lives in
 * packages/shared so both the comparison builder (producer) and the studio
 * Remotion composition (consumer) validate against the exact same schema.
 */
